...
Plan what you're eating this week. Browse a catalogue of 25 recipes, drop them into
...
**Recipes**
- 25 recipes, each with tags, cooking time, ingredients and a short method
...
**Adding a meal**
- **Add to week** on any card (or in the detail panel) opens a small dialog
...
| Empty slot's **+ Add** jumps to Recipes | Rather than building a second recipe browser inside the week view |
...
| Redraw the whole view, no diffing | 25 recipes is small; the simplicity is worth more than the cycles saved |
